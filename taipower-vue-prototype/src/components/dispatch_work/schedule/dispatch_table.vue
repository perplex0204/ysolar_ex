        ...
        <div style="overflow-y: scroll;">
            ...
            <transition mode="out-in" :name="page_direction == 'to' ? 'table_animation_to':'table_animation_back'">
                <div class="w-100 responsive_table_body" :key="currentPage">
                        ...
                        v-for="data in tableData" :key="data._id" @click="$emit('dispatch-edit', data)">
                            ...
                            <!-- <div class="col-12 col-lg-3 ">
                                <div class="d-lg-none d-flex">
                                    <label class="fs-6 fw-bold d-lg-none">編輯</label>
                                    <button class="btn btn-success ms-2" @click.stop="$emit('dispatch-edit', data)">編輯</button>
                                </div>
                                <button class="d-none d-lg-block btn btn-success position-relative top-50 start-50 translate-middle"
                                @click.stop="$emit('dispatch-edit', data)">編輯</button>
                            </div> -->
                        </div>
                </div>
            </transition>
