<template>
    <div>
        <div class="row g-0 mt-2" v-if="$store.state.user_data.pageType != 'taipower'" :class="{'me-2': $store.state.user_data.pageType != 'taipower'}">
            <button type="button" class="btn btn-primary btn-sm col-12 col-sm-9 col-md-6 col-lg-3 col-xl-2"
                @click="selectToday"
        ...
        <div class="row g-0" :class="{'me-2': $store.state.user_data.pageType != 'taipower'}">
            <button type="button" class="btn btn-primary btn-sm col-12 col-sm-9 col-md-6 col-lg-3 col-xl-2 auto_date_range mt-2"
            ...
            <button type="button" class="d-none btn btn-primary btn-sm col-12 col-sm-9 col-md-6 col-lg-3 col-xl-1 manual_date_range mt-2 ms-lg-2"
                @click="setRangeType($event)"
        ...
        <div class="row g-0 mb-4" :class="{'me-2': $store.state.user_data.pageType != 'taipower'}">
            <div class="col-12 col-md-6 col-lg-3 col-xl-3 text-center mt-2">
                <!-- 起始時間 -->
                <el-date-picker
                    v-model="startDate"
                    placeholder="開始日期"
            ...
            <div class="col-12 col-md-6 col-lg-5 col-xl-4 col-xxl-6 d-flex  align-items-center ms-2 mt-2" v-if="$store.state.user_data.pageType != 'taipower'">
                <el-button
            ...
            <div class="col-12 col-md-6 col-lg-4 col-xl-3 col-xxl-2 text-center mt-2 d-none">
                <!-- 結束時間 -->
                <el-date-picker
                    v-model="endDate"
                    type="date"
            ...
            <div class="col-12 col-md-6 col-lg-5 col-xl-4 col-xxl-3 d-flex  align-items-center ms-2 mt-2 d-none">
                <el-button
...
export default {
    ...
    methods: {
        ...
        searchDateRange() {
            ...
            this.$emit('setDate', {date_list: [start_date, end_date], mode: this.mode == 'today'? 'single':this.mode});   //傳遞已選擇的ID到外層
        },
    },
};
</script>
