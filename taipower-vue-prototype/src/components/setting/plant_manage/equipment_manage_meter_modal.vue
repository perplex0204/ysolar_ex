<template>
    <div class="modal" tabindex="-1" ref="meter_create_modal">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title"> meter create </h5>
...
export default {
    ...
    data() {
        return {
            ...
            max_usage: '',
            meter_modal_status: this.modalStatus
        }
    },

    mounted() {
        this.meter_create_modal = new Modal(
            this.$refs.meter_create_modal
        );
        let that = this;
    ...
    methods: {
        set_clicked() {
            this.meter_create_modal.hide();
        }
    },
    watch: {
        modalStatus: function () {
            if (this.modalStatus == true) {
                this.meter_create_modal.show();
            }
            this.meter_modal_status = false
            this.$emit('update', this.meter_modal_status)
        }
    }
}
</script>