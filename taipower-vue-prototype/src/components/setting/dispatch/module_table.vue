<template>
    <div class="col-12 col-lg-12 responsive_table">
        <div style="overflow-y: scroll;">
            ...
            <transition mode="out-in" :name="page_direction == 'to' ? 'table_animation_to':'table_animation_back'">
                <div class="w-100 responsive_table_body" :key="currentPage">
                        ...
                        v-for="data in tableData" :key="data.model">
        ...
        <div class="w-100 responsive_table_footer pt-4 pb-4 d-flex justify-content-between justify-content-lg-center"
...
export default {
    ...
    methods: {
        ...
        save_wash_cost(data){
            if(typeof(data.wash_cost) != "number"){
                alert(this.$i18n.t('setting.dispatch.wash_cost_not_number'))
                return false
            }
