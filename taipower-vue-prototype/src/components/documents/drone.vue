<template>
    <div class="d-flex flex-column">
        <div class="d-flex flex-wrap w-100">
            <!-- upload -->
            <el-upload
                :action="`${this.axios.defaults.baseURL}/documents/upload_drone`"
                :data="{
                    ID: stationId
                }"
...
export default {
    ...
    methods: {
        upload_documents_photo_get(){
            this.axios.post('/documents/upload_documents_drone_get', {
                ID: this.stationId,
        ...
        delete_data(file_id, ask=true){
            ...
            if(answer){
                console.log(file_id)
                this.axios.post('/documents/upload_documents_drone_delete', {ID: file_id})
                let index = null
